export const verificationEmailHtml = `<head>
...
<table bgcolor="#fdfdfd"
    ...
    <div style="text-align: center;">
        <p style="font-size: 24px;">Thanks for joining us.</p>
        <a style="font-size: 40px; margin-top: 20px;" href="[REDIRECT_URL]">Verify registration.</a>
    </div>
</table>
</body>`